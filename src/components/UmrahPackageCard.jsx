...
const UmrahPackageCard = () => {
  return (
    ...
    >
      {/* Header Image */}
      <div
        className="card-img-top d-flex align-items-center mt-2 justify-content-center"
      ...
      {/* Card Body */}
      <div className="m-3 rounded-3 ps-3 pt-4" style={{ background:'#F7F8F8'}}>
        <h2
        ...
        <div className="mb-1">
          <h6
            ...
            style={{ color: "#757D83", fontStyle: "italic" }}
          >
            Hotels:
          </h6>
        ...
        <div className="mb-1">
          ...
          <div className="small" style={{ color: "#333E47" }}>
            <div>
              <strong>Travel Date:</strong> SV 234-LHE-JED
              19-DEC-2024-23:20-01:20
            </div>
            <div>
              <strong>Return Date:</strong> SV 234-LHE-JED
              19-DEC-2024-23:20-01:20
            </div>
          </div>
        </div>
        ...
        {/* Food */}
        <div className="mb-4">
          <h6 className="fw-bold mb-1" style={{ color: "#666" }}>
            FOOD
          </h6>
          <div className="small  style={{color:'#333E47'}}fw-bold">N/A</div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-white rounded-pill py-2 px-4 d-inline-block">
            <h3
